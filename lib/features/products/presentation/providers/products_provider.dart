...
final prodcutsProvider = StateNotifierProvider<ProductsNotifier, ProductsState>((ref) {
...
class ProductsNotifier extends StateNotifier<ProductsState> {
  ...
  Future<bool> createOrUpdateProduct( Map<String, dynamic> productLike ) async {
    ...
    try {
      ...
      state = state.copyWith( products: state.products.map( (el) => (el.id == product.id) ? product : el ).toList() );
      return true;
    } catch (e) {
      return false;
    }
